"""
app.py — tkinter GUI for the Collision Detector.

Depends on src.core for all data loading and computation; contains no
...
from src.core import compute_collisions, load_json
...
class App(tk.Tk):
    ...
    def _build_main_area(self):
        ...
        self._tree.tag_configure("group", font=("Helvetica", 10, "bold"), foreground="#1a252f")
        ...
        self._detail.tag_configure("title",    font=("Helvetica", 12, "bold"), foreground="#2c3e50", spacing3=4)
        self._detail.tag_configure("subtitle", font=("Helvetica", 10),         foreground="#7f8c8d", spacing3=10)
        self._detail.tag_configure("teacher",  font=("Helvetica", 11),         foreground="#2c3e50", lmargin1=6, lmargin2=6, spacing1=3)
        self._detail.tag_configure("hint",     font=("Helvetica", 10, "italic"), foreground="#95a5a6")
